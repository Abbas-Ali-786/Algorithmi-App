...
String? scanText;
var isScannedFreelancerId = false.obs;
var isScannedShopOwnerId = false.obs;
var isScannedShopOwnerLicense = false.obs;

class ScanIdCameraScreen extends StatefulWidget {
  const ScanIdCameraScreen({Key? key}) : super(key: key);

  @override
  State<ScanIdCameraScreen> createState() => _ScanIdCameraScreenState();
}

class _ScanIdCameraScreenState extends State<ScanIdCameraScreen> {
  @override
  void initState() {
      ...
      body: SizedBox(
        ...
        child: Column(
          ...
          children: [
            getCustomTextW6S16(
                text:
                'Please Place the back of your\nEmirates ID inside the frame'.tr,
                color: textWhiteColor,
                textAlign: TextAlign.center),
            getVerSpace(10.h),
            getSvgImage('scan_id_white.svg', height: 19.h)
          ],
        ),
      ),
    );
                    ...
                    Container(
                      ...
                      child: Center(
                          child: OutlinedButton(
                              ...
                              child: getCustomTextW6S16(text: 'Scan Card'.tr, color: pinkAppColor))),
                    ),
                  ],
                )
                    : Center(
