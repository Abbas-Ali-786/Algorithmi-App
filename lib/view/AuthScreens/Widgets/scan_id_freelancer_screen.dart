...
import 'package:algorthimi/view/AuthScreens/Widgets/welldone_screen.dart';
...
class ScanIdFreelancerScreen extends StatefulWidget {
  const ScanIdFreelancerScreen({Key? key}) : super(key: key);

  @override
  State<ScanIdFreelancerScreen> createState() => _ScanIdFreelancerScreenState();
}

class _ScanIdFreelancerScreenState extends State<ScanIdFreelancerScreen> {
                          ...
                          child: Theme(
                            ...
                            child: Stepper(
                              ...
                              steps: <Step>[
                                Step(
                                  title: const Text(''),
                                  content: isScannedFreelancerId.value
                                      ? Column(
                                    children: [
                                      getCustomTextW6S15(
                                          text:
  ...
  continued() {
    currentStep.value < 3 ? currentStep.value += 1 : null;
  }
