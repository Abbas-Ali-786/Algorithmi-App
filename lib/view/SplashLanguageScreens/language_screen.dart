          ...
          body: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    authController.isOpenLanguage.value = !authController.isOpenLanguage.value;
                    authController.update();
                    print('auth controller lanaguage open value is ${authController.isOpenLanguage.value}');
                  },
                  child: Container(
                                ...
                                children: [
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                        ...
                                        border: Border.all(
                                            color: authController.selectedLanguage.value ==
                                                index
                                                ? pinkAppColor
                                                : borderColor,
                                            width: authController.selectedLanguage.value ==
                                                index
                                                ? 4.px
                                                : 1.5.px)),
                                  ),
